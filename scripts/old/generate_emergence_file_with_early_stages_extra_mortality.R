...
pupal_test_pop = ode(y = c(N=1), times = seq(1,length(tvec),1), func = pupal_test_ode, parms = list(pupal_development_rate, pupal_timeseries_nn6, DeathRate), method='rk')[,"N"]
save(pupal_timeseries, pupal_timeseries_nn2, pupal_timeseries_nn4, pupal_timeseries_nn6, file="pupal_timeseries.RData")


egg_timeseries = get_egg_timeseries_ode_2(adult_timeseries_trend,egg_mortality, egg_development_rate,gonotrophic_cycle_rate,eggs_per_gon_cycle, 12, tvec)
...
population_timeseries[,1] = ode(y = initial_conditions_4, times = seq(1,length(tvec),1), func = full_model_ode_2, parms = params_4)[,"N"]
population_timeseries[,2] = ode(y = initial_conditions_6, times = seq(1,length(tvec),1), func = full_model_ode_2, parms = params_6)[,"N"]
