...
#egg_test_pop = ode(y = c(L=larval_timeseries[1], P=pupal_timeseries[1], N=adult_timeseries_trend[1]), times = seq(1,length(tvec),1), func = alternative_egg_test_ode, parms = list(egg_development_rate, larval_development_rate, pupal_development_rate, egg_timeseries, larval_mortality, pupal_mortality, DeathRate, larval_capacity, larval_power))[,"N"]
...
# from very high -------------------------
#==================================================
initial_conditions = c(E =1000, L = 1000, P = 1000, N = 1000)
params = list(egg_development_rate, larval_development_rate, pupal_development_rate, female_egg_laying_timeseries_nn6, egg_mortality, larval_mortality, pupal_mortality, DeathRate, larval_capacity, larval_power)
population_timeseries = ode(y = initial_conditions, times = seq(1,length(tvec),1), func = full_model_ode, parms = params)[,"N"]

plot(adult_timeseries_trend, col='blue', type='l')
lines(seq(1,length(tvec),1), population_timeseries)
...
#writeLines(paste("extra_mortality = ", additional_random_death_rate), fileName)
close(fileName)
